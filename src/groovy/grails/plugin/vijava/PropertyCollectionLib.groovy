...
class PropertyCollectionLib {
    ...
    static List<ObjectContent> collectProperties(Map<String, List<String>> specDeclaration, ManagedEntity root, SelectionSpec[] selectionSpecs) throws InvalidType, InvalidProperty {
        ...
        return collectProperties(root, propertyFilterSpecs)
    }
     ...
     * type within the PropertySpec collection.
     */
    static List<ObjectContent> collectProperties(ManagedEntity root, PropertyFilterSpec[] propertyFilterSpecs) throws InvalidType, InvalidProperty {
        return root.serverConnection.vimService.retrieveProperties(root.serverConnection.serviceInstance.propertyCollector.MOR, propertyFilterSpecs)
    }
